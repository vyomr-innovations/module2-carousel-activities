...
import "swiper/css";
import SlideData from "@/carousel-C15-L2-A3/slideData.json"
      ...
      <div className="w-[950px] px-2">
        ...
        >
          ...
          <div className="grid grid-cols-12 ">
            <div className="col-span-6 h-[450px] w-full relative">
            ...
            <div className="col-span-6 flex justify-center items-center flex-col gap-4">
              <h3 className="text-black font-bold text-2xl">{item.title}</h3>
